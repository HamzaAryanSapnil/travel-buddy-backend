...
router.post("/", (0, auth_1.default)("USER", "ADMIN"), (0, validateRequest_1.default)(tripMember_validation_1.TripMemberValidation.addMember), tripMember_controller_1.TripMemberController.addMember);
...
router.patch("/:id/role", (0, auth_1.default)("USER", "ADMIN"), (0, validateRequest_1.default)(tripMember_validation_1.TripMemberValidation.updateRole), tripMember_controller_1.TripMemberController.updateMemberRole);
