...
const getMembers = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const authUser = req.user;
    const result = yield tripMember_service_1.TripMemberService.getMembers(authUser, req.params.planId);
    (0, sendResponse_1.default)(res, {
...
const removeMember = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const authUser = req.user;
    yield tripMember_service_1.TripMemberService.removeMember(authUser, req.params.id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
